...
public final class StreamResource {
    ...
    public func listChannels() async throws -> [[String: Any]] {
        try await client.requestArray(method: "GET", path: "/api/v1/stream/channels")
    }

    /// Get channel details.
    public func getChannel(_ id: String) async throws -> [String: Any] {
        try await client.requestDict(method: "GET", path: "/api/v1/stream/channels/\(id)")
    }

    /// Create a stream channel.
    public func createChannel(_ body: [String: Any]) async throws -> [String: Any] {
        try await client.requestDict(method: "POST", path: "/api/v1/stream/channels", body: body)
    }

    /// Update a channel.
    public func updateChannel(_ id: String, _ body: [String: Any]) async throws -> [String: Any] {
        try await client.requestDict(method: "PUT", path: "/api/v1/stream/channels/\(id)", body: body)
    }
    ...
    public func listMessages(_ channelId: String) async throws -> [[String: Any]] {
        try await client.requestArray(method: "GET", path: "/api/v1/stream/channels/\(channelId)/messages")
    }

    /// List active subscriptions.
    public func listSubscriptions() async throws -> [[String: Any]] {
        try await client.requestArray(method: "GET", path: "/api/v1/stream/subscriptions")
    }
    ...
    public func publish(_ body: [String: Any]) async throws -> [String: Any] {
        try await client.requestDict(method: "POST", path: "/api/v1/stream/events", body: body)
    }
}
