...
public final class ConnectorResource {
    ...
    public func list() async throws -> [[String: Any]] {
        try await client.requestArray(method: "GET", path: "/api/v1/connectors")
    }

    /// Get a connector by ID.
    public func get(_ id: String) async throws -> [String: Any] {
        try await client.requestDict(method: "GET", path: "/api/v1/connectors/\(id)")
    }

    /// List connector configurations.
    public func listConfigs() async throws -> [[String: Any]] {
        try await client.requestArray(method: "GET", path: "/api/v1/connectors/configs")
    }

    /// Create a connector configuration.
    public func createConfig(_ body: [String: Any]) async throws -> [String: Any] {
        try await client.requestDict(method: "POST", path: "/api/v1/connectors/configs", body: body)
    }

    /// Update a connector configuration.
    public func updateConfig(_ id: String, _ body: [String: Any]) async throws -> [String: Any] {
        try await client.requestDict(method: "PUT", path: "/api/v1/connectors/configs/\(id)", body: body)
    }
